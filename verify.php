...
if(isset($_GET['vkey'])){
    ...
    $result= $mysqli->query("select verified, vkey from user where verified = 0 AND vkey = '$vkey' LIMIT 1");
...
<body>
  ...
  <header class="header-area">
    ...
    <div class="container">
        ...
        echo "The account is invalid or is already verified";
    }
...
?>
    <p class="text center"><a href="login.php"><h1>Sign In</h1></a></p>
    </div>
    </div>
    </div>
    </div>
